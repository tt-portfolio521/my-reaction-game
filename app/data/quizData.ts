    ...
    difficulties: [
      {
        ...
        questions: [
          ...
          {
            questionNumber: 3,
            question: "「上」という漢字。一画目はどれ？",
            options: [
              { text: "上の横線（一）", isCorrect: false },
              { text: "下の横線（一）", isCorrect: false },
              { text: "縦の線（｜）", isCorrect: true, rationale: "意外ですが、「縦（｜）」→「横（短）」→「横（長）」の順で書きます。" },
              { text: "ななめの線", isCorrect: false },
            ],
            hint: "実は「縦棒」から書き始めます。",
          },
          {
            questionNumber: 4,
            question: "「一段落」の本来の正しい読み方は？",
            options: [
              { text: "ひとだんらく", isCorrect: false },
              { text: "いちだんらく", isCorrect: true, rationale: "「一（いち）」＋「段落」です。「ひとだんらく」は誤用が定着したものです。" },
              { text: "いちだんおち", isCorrect: false },
              { text: "ひとだんおち", isCorrect: false },
            ],
            hint: "「一大事（いちだいじ）」と同じ読み方です。",
          },
          {
            questionNumber: 5,
            question: "「他人事」の本来の正しい読み方は？",
            options: [
              { text: "たにんごと", isCorrect: false },
              { text: "ひとごと", isCorrect: true, rationale: "「他人（たにん）」と書いても、本来の読みは「ひとごと」です。「たにんごと」は誤読が定着したものです。" },
              { text: "よそごと", isCorrect: false },
              { text: "しらんぷり", isCorrect: false },
            ],
            hint: "「他人（たにん）」という漢字の読みに惑わされないで。",
          },
        ],
      },
      {
